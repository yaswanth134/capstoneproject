...
public class whishlist extends BaseTest{
    ...
    public void testaddtoWishlist() {
    	test = extent.createTest("wishlist Test", "Test the wishlist without login process");
    	try {
    ...
    public void addWishlisttocartwithlogin() throws InterruptedException {
    	test = extent.createTest("wishlist Test", "remove wishlist the login process");
            ...
            try {
            	WebElement title=wait0.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"maincontent\"]/div[2]/div[1]/div[3]/div/p/span")));
            	String Expcted="1 Item ";
        		Assert.assertEquals(Expcted,title.getText());
